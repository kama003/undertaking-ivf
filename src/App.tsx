...
export default function App() {
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      case 'dashboard': return <div key={dashboardKey}><Dashboard documents={documents} /></div>;
      case 'generate': 
        if (userRole === 'viewer') return <div key={dashboardKey}><Dashboard documents={documents} /></div>;
